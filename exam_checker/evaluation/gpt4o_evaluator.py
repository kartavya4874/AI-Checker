...
SYSTEM_PROMPT = (
    ...
    "FLEXIBLE RULES: "
    "Be lenient and give the benefit of the doubt. Accept partial answers and alternative interpretations easily. "
    "Focus on core conceptual understanding rather than exact keyword matches. "
